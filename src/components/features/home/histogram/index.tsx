...
const Histogram = ({
  ...
  useEffect(() => {
    if (currentBinId !== undefined && scrollContainerRef.current && selectedBinRef.current) {
      setTimeout(() => {
    ...
    <div className="w-full" style={{ height: CHART_CONFIG.height }}>
      ...
      >
        {reversedBinIndices.map((binIndex) => {
          ...
          const share = totalShares > 0n ?
            Number((marketData.values[binIndex] * 10000n) / totalShares) / 100 : 0;
          return (
            <div
              ...
              className={cn(
                ...
                binIndex === currentBinId ? "bg-bitcoin bg-opacity-20" : "group hover:bg-primary-50 hover:bg-opacity-50"
              )}
            >
                ...
                <div
                  className={cn(
                    ...
                    binIndex === currentBinId
                      ...
                      : "bg-primary-50 opacity-50 group-hover:bg-primary-200 group-hover:opacity-100"
                  )}
                  style={{ width: `${share}%` }}
                />
                <div
                  className={cn(
                    ...
                    binIndex === currentBinId
                      ...
                      : "font-light text-surface-on-var group-hover:text-surface-on group-hover:font-bold"
                  )}
                >
